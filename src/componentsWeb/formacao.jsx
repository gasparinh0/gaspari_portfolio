  ...
  >
    ...
    <div className='flex items-center'>
      ...
      <div className='ml-2'>
        ...
        <div className='flex gap-1'>
          <p className='italic text-[#c1cccc]'>Engenharia de computação |</p>
          <p className='italic text-[#c1cccc]'>02/2023 - 12/2027</p>
        </div>
      </div>
    </div>
    ...
    <div className='flex items-center'>
      ...
      <div className='ml-2'>
        ...
        <div className='flex gap-1'>
          ...
          <p className='italic text-[#c1cccc]'>02/2023 - Cursando</p>
        </div>
      </div>
    </div>
