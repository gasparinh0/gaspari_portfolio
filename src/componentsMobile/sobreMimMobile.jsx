  ...
  return (
    ...
    >
      ...
      <p className='text-white font-light'>
        ...
        pela ETEC João Belarmino e também estou cursando engenharia de computação pela USF.
      </p>
          ...
          <Card sx={{ maxWidth: 290, backgroundColor: '#303236', color: 'white' }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="white">
                Atualmente atuo pela parte do front-end, prototipando e desenvolvendo as telas de todo projeto no qual eu faço parte.
              </Typography>
            </CardContent>
          </Card>
      ...
      <div className='grid grid-cols-3 align-middle'>
        ...
        <div className='flex flex-col items-center'>
          <div className='group relative rounded-full p-2 transition duration-300 hover:bg-[#303236]'>
            <SiArduino size={45} color='#009297' className='transition-opacity duration-300 group-hover:opacity-0' />
            <p className='absolute inset-0 flex items-center justify-center text-white font-semibold opacity-0 group-hover:opacity-100'>
              40%
            </p>
          </div>
          <p className='text-[#c1cccc] font-light'>Arduino</p>
        </div>
        ...
        <div className='flex flex-col items-center'>
          <div className='group relative rounded-full p-2 transition duration-300 hover:bg-[#303236]'>
            <BiLogoPhp size={45} color='#7377ad' className='transition-opacity duration-300 group-hover:opacity-0' />
            <p className='absolute inset-0 flex items-center justify-center text-white font-semibold opacity-0 group-hover:opacity-100'>
              40%
            </p>
          </div>
          <p className='text-[#c1cccc] font-light'>PHP</p>
        </div>
